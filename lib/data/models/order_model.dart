...
class OrderModel {
  ...
  static OrderEntity fromFirestore(DocumentSnapshot doc) {
    ...
    return OrderEntity(
      ...
      customerName: data['customerName'] as String? ?? data['userName'] as String?,
      customerPhone: data['customerPhone'] as String? ?? data['userPhone'] as String? ?? data['phone'] as String?,
